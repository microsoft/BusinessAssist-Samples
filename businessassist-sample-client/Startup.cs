...
namespace BusinessAssistAPIClient
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMicrosoftIdentityWebAppAuthentication(Configuration)
                    .EnableTokenAcquisitionToCallDownstreamApi(new string[] { Configuration["BusinessAssist:BAServiceScope"] })
                    .AddInMemoryTokenCaches();

            //Enables to add client service to use the HttpClient by dependency injection.
            services.AddBAService();
